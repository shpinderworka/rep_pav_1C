...
Сценарий: Покупка
	...
	Тогда результат проведения корректен
		...
		Тогда таблица формы с именем "Список" стала равной:
			| 'Номенклатура'        | 'Номер строки' | 'Сумма'    | 'Контрагент'         | 'Количество' |
			| 'Страшная загогулина' | '1'            | '2 000,00' | 'ООО "Зеленый свет"' | '100,00'     |
			| 'Красивая загогулина' | '2'            | '150,00'   | 'ООО "Зеленый свет"' | '15,00'      |
